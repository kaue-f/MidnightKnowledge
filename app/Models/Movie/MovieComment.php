...
class MovieComment extends Model
{
     ...
     */
    protected $fillable = ['movie_id', 'user_id', 'comment', 'like', 'dislike'];

    /**
     * Define the relationship with Movie.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<Movie, MovieComment>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<User, MovieComment>
     */
