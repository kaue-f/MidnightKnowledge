<x-modal wire:model="modalAnime" title="Cadastrar Anime" class="backdrop-blur" box-class="p-6 w-11/12 max-w-4xl">
                    ...
                    <div class="flex space-x-4 w-full">
                        <div class="w-1/2">
                            <x-choices label="Classificação" placeholder="Classificação" single option-avatar="image"
                                ...
                                :options="$classifications" wire:model="animeForm.classification" />
                        </div>
                        <div class="w-1/2">
