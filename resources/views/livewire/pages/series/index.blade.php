<section>
            ...
            <div class="w-full justify-center gap-4">
                <div class="filter">
                    <input class="btn btn-sm btn-neutral border-accent checked:btn-primary" type="radio"
                        name="serie" aria-label="Título" wire:click="seriesQuery('title|asc')" />
                    <input class="btn btn-sm btn-neutral border-accent checked:btn-primary" type="radio"
                        name="serie" aria-label="Classificação" wire:click="seriesQuery('ratings_avg_rating|desc')" />
                    <input class="btn btn-sm btn-neutral border-accent checked:btn-primary" type="radio"
                        name="serie" aria-label="Recentemente" wire:click="seriesQuery('created_at|desc')" />
                    <input class="btn btn-sm btn-neutral border-accent checked:btn-primary" type="radio"
                        name="serie" aria-label="Ano de Lançamento" wire:click="seriesQuery('release_date|desc')" />
    ...
    <livewire:components.modals.create-serie :user="Auth::user()" :$classifications :$genres
        wire:model.live="modalSerie" />
</section>
